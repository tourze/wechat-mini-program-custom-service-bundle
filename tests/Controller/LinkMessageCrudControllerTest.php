 ...
 * @internal
 */
#[CoversClass(LinkMessageCrudController::class)]
#[RunTestsInSeparateProcesses]
class LinkMessageCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    ...
    protected function getControllerService(): LinkMessageCrudController
    {
        return self::getService(LinkMessageCrudController::class);
    }
    ...
    {
        $controller = new LinkMessageCrudController();
        $entity = $controller->createEntity(LinkMessage::class);
    ...
    public function testValidationErrors(): void
    {
        ...
        $this->assertGreaterThan(0, count($violations), 'Empty LinkMessage should have validation errors');
